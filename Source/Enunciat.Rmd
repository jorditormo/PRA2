...
Creem dos dataset on separem les variables numèriques de les categòriques:
...
En aquests gràfics podem veure que totes les columnes excepte "age" tenen punts individuals fora de les bigues, aquests valors són els que s'han considerat com extrems. Anem a analitzar-los cas a cas.
...
```{r}
boxplot(data$oldpeak,plot=FALSE)$out
```
